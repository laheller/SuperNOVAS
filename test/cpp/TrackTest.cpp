...
int main() {
  TestUtil test = TestUtil("HorizontalTrack");
  ...
  HorizontalTrack hx = HorizontalTrack(Time::j2000(), Interval(1.0), xe, xe, xe);
  if(!test.check("invalid is_valid()", !hx.is_valid())) n++;
  if(!test.check("invalid longitude_at()", !hx.longitude_at(t1).is_valid())) n++;
  if(!test.check("invalid latitude_at()", !hx.latitude_at(t1).is_valid())) n++;
  if(!test.check("invalid distance_at()", !hx.distance_at(t1).is_valid())) n++;
  if(!test.check("invalid raidal_velocity_at()", !hx.radial_velocity_at(t1).is_valid())) n++;
  if(!test.check("invalid projected_at()", !hx.projected_at(t1).is_valid())) n++;
  ...
  EquatorialTrack ex = EquatorialTrack(Equinox::icrs(), Time::j2000(), Interval(1.0), xe, xe, xe);
  if(!test.check("invalid is_valid()", !ex.is_valid())) n++;
  if(!test.check("invalid longitude_at()", !ex.longitude_at(t1).is_valid())) n++;
  if(!test.check("invalid latitude_at()", !ex.latitude_at(t1).is_valid())) n++;
  if(!test.check("invalid distance_at()", !ex.distance_at(t1).is_valid())) n++;
  if(!test.check("invalid raidal_velocity_at()", !ex.radial_velocity_at(t1).is_valid())) n++;
  if(!test.check("invalid projected_at()", !ex.projected_at(t1).is_valid())) n++;
